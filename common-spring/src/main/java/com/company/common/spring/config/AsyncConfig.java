...
public class AsyncConfig {
    ...
    public TaskExecutor getAsyncExecutor() {
        log.info("corePoolSize : " + this.appConfigurationProperties.getAsyncExecutorCorePoolSize() + ", MaxPoolSize : " + this.appConfigurationProperties.getAsyncExecutorMaxPoolSize());
